...
const socialFields = [
  { icon: Share2, label: "Facebook page", value: salesAgent.socials[0]?.value ?? "" },
  { icon: AtSign, label: "Instagram", value: salesAgent.socials[1]?.value ?? "" },
  { icon: Globe, label: "LinkedIn", value: salesAgent.socials[2]?.value ?? "" },
  { icon: Globe, label: "Other website", value: "" }
];

export default function RealtorContactProfilePage() {
            ...
            <section className="realtor-form-panel reveal scroll-reveal">
              ...
              <div className="realtor-field-grid">
                ...
                <label className="realtor-field">
                  ...
                  <input defaultValue="+63 917 000 0000" readOnly={!isEditing} required type="tel" />
                </label>
                <label className="realtor-field">
                  <span>Email address</span>
                  <input defaultValue="sales@example.com" readOnly={!isEditing} required type="email" />
                </label>
                <label className="realtor-field">
